...
func addMaintenancHistoryeMigrations(mg *Migrator) {

  malfunalert_historyV1 := Table{
    Name: "malfunalert_history",
    Columns: []*Column{
  ...
  mg.AddMigration("create maintenance_history  table v1-7", NewAddTableMigration(malfunalert_historyV1))
  addTableIndicesMigrations(mg, "v1-7", malfunalert_historyV1)
