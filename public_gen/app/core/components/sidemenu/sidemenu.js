    ...
    return {
        ...
        execute: function() {
            SideMenuCtrl = (function () {
                ...
                SideMenuCtrl.prototype.openAdminDropdown = function () {
                    ...
                    if (this.isSignedIn) {
                     ...
                     this.AdmMenu.push();
                    if (this.contextSrv.hasRole('Admin')) {
                        this.AdmMenu.push({ section: this.user.orgName, cssClass: 'dropdown-menu-title' });
                        this.AdmMenu.push({
                            text: "Process",
                            url: this.getUrl("/org/process"),
                        });
                        this.AdmMenu.push({
                            text: "Machine",
                            url: this.getUrl("/org/machine"),
                        });
                        this.AdmMenu.push({
                    ...
                    this.AdmMenu.push({ cssClass: "divider" });
                    this.backendSrv.get('/api/user/orgs').then(function (orgs) {
                        orgs.forEach(function (org) {
                            if (org.orgId === _this.contextSrv.user.orgId) {
                                return;
