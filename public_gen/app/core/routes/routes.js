...
System.register(['./dashboard_loaders', 'app/core/core_module', './bundle_loader'], function(exports_1) {
 ...
 .when('/org/process/edit/:processId', {
   ...
   .when('/org/subprocess/edit/:subProcessId', {
                              templateUrl: 'public/app/features/org/partials/updateSubProcess.html',
                              controller: 'OrgEditSubProcess',
                              controllerAs: 'ctrl',
                              resolve: loadOrgBundle,
                          })
.when('/org/subprocess/update/:subProcessId', {
                              templateUrl: 'public/app/features/org/partials/editSubProcess.html',
                              controller: 'OrgEditSubProcess',
                              controllerAs: 'ctrl',
                              resolve: loadOrgBundle,
                          })
