  ...
  this.render = function() {
    if (ngModelCtrl.$viewValue) {
      ...
      if (isValid) {
        ...
        $log.error('Datepicker directive: "ng-model" value must be a Date object, a number of milliseconds since 01.01.2016 or a string representing an RFC2822 or ISO 8601 date.');
      }
    }
    this.refreshView();
  };
