...
func TestPresignRequest(t *testing.T) {
	...
	expectedCred := "AKID/20160101/us-east-1/dynamodb/aws4_request"
...
func TestSignRequest(t *testing.T) {
	...
	expectedDate := "20160101T000000Z"
	expectedSig := "AWS4-HMAC-SHA256 Credential=AKID/20160101/us-east-1/dynamodb/aws4_request, SignedHeaders=host;x-amz-date;x-amz-meta-other-header;x-amz-security-token;x-amz-target, Signature=69ada33fec48180dab153576e4dd80c4e04124f80dda3eccfed8a67c2b91ed5e"
